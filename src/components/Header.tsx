...
export const Header: React.FC<HeaderProps> = ({ onOpenDrawer }) => {
  return (
    <header className="fixed top-0 left-0 right-0 z-30 flex items-center justify-between px-4 sm:px-6 md:px-12 py-4 sm:py-6 bg-gradient-to-b from-[#030014]/90 via-[#030014]/40 to-transparent backdrop-blur-[2px]">
      ...
      >
        <span className="font-display text-xl sm:text-2xl md:text-3xl tracking-widest text-white transition-colors group-hover:text-[#CCFF00]">
          ARPAN
        </span>
        <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full bg-[#CCFF00] text-black flex items-center justify-center font-display font-bold text-sm sm:text-base md:text-lg shadow-[0_0_15px_rgba(204,255,0,0.4)] transition-transform duration-500 ease-out group-hover:rotate-180 group-hover:scale-110 leading-none">
          A
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <button
          ...
          className="group relative inline-flex items-center gap-1.5 md:gap-2 font-mono text-xs px-3.5 sm:px-5 py-2 md:py-2.5 rounded-full border border-white/20 bg-white/5 backdrop-blur-md text-white hover:border-[#CCFF00] hover:bg-[#CCFF00] hover:text-black font-semibold transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.3)] hover:shadow-[0_0_25px_rgba(204,255,0,0.5)] active:scale-95 cursor-pointer"
        >
